...
{
    public class AzureSqlDatabaseDbContextConnectorFactory : AzureSqlDatabaseProviderConnectorFactory
    {
        public AzureSqlDatabaseDbContextConnectorFactory(AzureSqlDatabaseServiceInfo info, AzureSqlDatabaseProviderConnectorOptions config, Type dbContextType)
        ...
        internal AzureSqlDatabaseDbContextConnectorFactory()
        {
        }
