...
{
    public class AzureSqlDatabaseProviderConnectorFactory
    {
        private AzureSqlDatabaseServiceInfo _info;
        private AzureSqlDatabaseProviderConnectorOptions _config;
        private AzureSqlDatabaseProviderConfigurer _configurer = new AzureSqlDatabaseProviderConfigurer();

        public AzureSqlDatabaseProviderConnectorFactory()
        {
        }

        public AzureSqlDatabaseProviderConnectorFactory(AzureSqlDatabaseServiceInfo sinfo, AzureSqlDatabaseProviderConnectorOptions config, Type type)
        {
