...
{
    public static class AzureSqlDatabaseDbContextContainerBuilderExtensions
    {
        /// <summary>
        ...
        public static IRegistrationBuilder<object, SimpleActivatorData, SingleRegistrationStyle> RegisterDbContext<TContext>(this ContainerBuilder container, IConfiguration config, string serviceName = null)
        {
            ...
            var sqlServerConfig = new AzureSqlDatabaseProviderConnectorOptions(config);
            var factory = new AzureSqlDatabaseProviderConnectorFactory(info, sqlServerConfig, typeof(TContext));
